...
ทั้งสามนี้ทำให้สัมผัสมือของเกมต่างกันราวฟ้ากับเหวแม้จะเป็นเอดจ์เดียวกัน ในขั้นสเปกให้กำหนดเพียงการมีอยู่ของเอดจ์และหน้าต่าง ส่วนวิธีเชื่อมต่อ (เบลนดิง vs เฟรมสกิป) มักจะกำหนดร่วมกับแอนิเมเตอร์ในขั้นบิลด์ อย่างไรก็ตามถ้าเว้นฟิลด์หนึ่งบรรทัดแบบ `transition: blend` / `transition: skip` ไว้ในสเปกล่วงหน้า ในขั้นบิลด์ก็ไม่ต้องมาถามซ้ำว่า "เอดจ์นี้ตกลงให้ข้ามแบบไหนนะ" วิธีเชื่อมต่อคือแกนที่สามที่ซ่อนอยู่ของกราฟคอมโบ
...
- แม้เป็นเอดจ์เดียวกัน วิธีเชื่อมต่อ (Cancel Notify·Anim Blending·Frame Skip) ก็ทำให้สัมผัสมือต่างกันราวฟ้ากับเหว
