...
> ก่อนอื่นผมจะแปลง expect_ms ของข้อกำหนดเป็นเฟรม ที่ 60fps frame = round(ms / 16.67) ครับ
>
...
> นี่คือเช็กลิสต์การตรวจสอบสำหรับ FAIL สองรายการ ไม่ฟันธงสาเหตุ แต่จัดเฉพาะจุดที่ต้องตรวจครับ
>
