...
1. **ชีต `$스키마`** — ฉบับที่ยึดเป็นหลักอันดับแรกของแต่ละชีตข้อมูล มีการระบุประเภท·Enum·เป้าหมาย FK แยกตามคอลัมน์ ถ้ามี FK เขียนอยู่ตรงนี้ นั่นคืออันดับ 1
