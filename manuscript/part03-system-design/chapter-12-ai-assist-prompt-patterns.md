...
จุดแรก รายการที่ตรวจเปลี่ยนไปทุกครั้ง วันนี้นึกถึง "cooldown ติดลบ" ได้ แต่พรุ่งนี้ลืม "PK ซ้ำ (Primary Key หรือคีย์หลัก)" ที่เคยกรองออกไปเมื่อวานหายไปจากพรอมต์ของวันนี้ การตรวจที่พึ่งพาความจำของคนย่อมตกหล่นตามสภาพร่างกายของคนในวันนั้น
...
เมโมทั้งสองผมจัดเป็น "กำลังพิจารณา·ขอความเห็น" และไม่ได้ใส่ถ้อยคำแจ้งแบบเคาะ
ขาดแล้ว ก่อนส่งคุณต้องเติมเอฟเฟกต์ตัวเลือกที่จะเปลี่ยน (ตำแหน่ง X) ด้วย
```
