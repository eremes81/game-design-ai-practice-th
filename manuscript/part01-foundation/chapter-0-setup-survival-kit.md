...
หลักการของการติดตั้งคือทำตามคำแนะนำอย่างเป็นทางการ เครื่องมือเปลี่ยนแปลงบ่อย และไฟล์ติดตั้งที่ได้มาจากแหล่งที่ไม่เป็นทางการนั้นอันตราย ด้วยเหตุนี้หนังสือเล่มนี้จึงไม่ได้ใส่ลิงก์ดาวน์โหลดไว้ แต่จะแนะนำวิธีค้นหาเส้นทางอย่างเป็นทางการแทน หากพิมพ์ "Claude Code 공식 문서" หรือ "Claude Code install" ในช่องค้นหา หน้าเอกสารทางการของบริษัท Anthropic จะปรากฏขึ้นมาเป็นอันดับแรก การใช้คำสั่งติดตั้งจากหน้านั้นตามที่ระบุไว้คือวิธีที่ปลอดภัยที่สุด
...
| `cd 폴더이름` | ซีดี | เข้าไปในโฟลเดอร์นั้น | ดับเบิลคลิกโฟลเดอร์ |
...
2. ค้นหา "Claude Code 공식 문서" แล้วเปิดหน้าคำแนะนำการติดตั้งอย่างเป็นทางการค้างไว้
