...
D1:
  ...
  owner: teammate_a
  rationale: ในการทดสอบการต่อสกิล 0.3 วินาทีมักทำให้อินพุตหลุดบ่อย (เนื้อหา 14:22)
...
- **affected_atoms**: แนะนำผู้เข้าชิงที่เป็นระบบ·ชีตข้อมูลที่ได้รับผลกระทบ
- **follow_up**: ผู้เข้าชิงที่เป็นแอ็กชันต่อเนื่องซึ่งสืบเนื่องมาจากการตัดสินใจ
...
3. affected_atoms (ผู้เข้าชิงจากการกล่าวถึงในเนื้อหา):
...
<svg viewBox="0 0 720 240" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="13">
  ...
  <text x="60" y="111" fill="#666">เพิ่มอีก 1 เดือน · บังคับรายการปิดของโฟลเดอร์ผู้เข้าชิง</text>
  <!-- step 3 -->
...
สิ่งที่สร้างความแตกต่างไม่ใช่ปริมาณงานของ AI แต่เป็น **โครงสร้างที่รักษาตำแหน่งที่คนประกาศการตัดสินใจเอาไว้ แล้วยกให้ AI ทำแค่การเติมเหตุผล** ในบันทึกการประชุม After ข้างต้น ถ้าลบย่อหน้าที่ AI เติมทั้งหมด (สรุปวาระ, การอ้างอิง rationale, ผู้เข้าชิง affected_atoms) ออกไป สิ่งที่เหลือคือการตัดสินใจหนึ่งบรรทัดกับ owner เท่านั้น — ปริมาณข้อมูลของบันทึกการประชุมกว่าครึ่งหนึ่งมาจากการเติมของ AI แต่หัวใจอยู่ที่ว่าครึ่งหนึ่งนั้นทั้งหมดเป็นการอ้างอิงเหตุผลที่ผ่านการตรวจสอบโดยมนุษย์แล้ว
