...
และในโฟลเดอร์นี้มีไฟล์ปฏิบัติการสองตัวอยู่ด้วยกัน คือ `_convert_md_to_html.py` กับ `_SyncToArtRepo.bat` สองไฟล์นี้คือกระดูกสันหลังของบทนี้
