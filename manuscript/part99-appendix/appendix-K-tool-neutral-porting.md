...
|---|---|---|
| มาตรฐาน → เทมเพลต → verification gate | ทำให้กฎที่ตกลงกัน (มาตรฐาน) แข็งตัวเป็นกรอบช่องว่าง (เทมเพลต) แล้ววางด่าน (gate) ที่กรองโดยอัตโนมัติว่าผลลัพธ์เป็นไปตามกฎหรือไม่ | แนวคิดเรื่องกฎ กรอบ และการตรวจสอบ สามารถแสดงออกได้ด้วยข้อความหรือสคริปต์ในเครื่องมือใดก็ได้ |
