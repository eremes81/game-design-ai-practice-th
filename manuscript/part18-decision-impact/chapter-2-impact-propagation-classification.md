...
ขณะที่กำลังจัดบันทึกการประชุมหลังประชุมเสร็จ มีการตัดสินใจบรรทัดเดียวเขียนอยู่ "รวมคูลดาวน์รวม (global cooldown) เป็น 0.5 วินาที" ในที่ประชุมใช้เวลาตกลงกันไม่ถึง 30 วินาที ทุกคนพยักหน้าเห็นด้วย แล้วก็ข้ามไปยังวาระถัดไป
...
แบบหนึ่งคือ **การจัดการน้อยเกินไป (under-processing)** การตัดสินใจที่สั่นสะเทือนทั้งโปรเจกต์อย่างการรวมคูลดาวน์รวม ถูกปฏิบัติเหมือนเป็น "เรื่อง 5 นาที" จึงเข้าสู่บิลด์โดยไม่ผ่านการตรวจสอบ กว่าการแพร่กระจายจะปรากฏก็ผ่านไปสองเดือน และตอนนั้นต้นทุนการย้อนกลับก็สั่งสมสูงเป็นภูเขาไปแล้ว
...
| T1 | ระบบ / ข้ามหลายสาขา | การรวมคูลดาวน์รวม, การเพิ่มอาชีพใหม่ | ประธาน TF + ผู้กำกับ | 1–2 สัปดาห์ |
...
ดูแค่ตารางก็เรียบร้อยเหมือนตำราเรียน แต่ความยากในงานจริงไม่ใช่การท่องตาราง แต่คือ **การตัดสินว่าการตัดสินใจหนึ่งเรื่องที่อยู่ตรงหน้าจะใส่ลงในช่องไหน** เราต้องรู้ว่า "การรวมคูลดาวน์รวม" คือ T1 ตั้งแต่วินาทีที่เขียนบันทึกการประชุม ไม่ใช่หลังจากประชุมจบ ด้วยเหตุนี้ เกณฑ์ 3 ข้อในหัวข้อถัดไปจึงเป็นหัวใจ
...
id: D2026_Q2_017
title: รวมคูลดาวน์รวมเป็น 0.5 วินาที
date: 2026-04-18
proposer: teammate_a
...
2. ต้นทุนการย้อนกลับ
   หากรวมคูลดาวน์รวมแล้วจะย้อนกลับ ก็ต้องแยกคูลดาวน์ของสกิลทุกตัว
...
ตรงนี้ผู้เขียนไม่ได้รับมาทั้งดุ้น ข้อ 1 ของผลลัพธ์เป็นจุดที่ต้องลงมือ LLM มองสาขาปรับสมดุลเป็น "ผลกระทบทางอ้อม" แต่ในโครงสร้างจริงของโปรเจกต์ A การรวมคูลดาวน์รื้อชีตปรับสมดุล **โดยตรง** — เพราะตัวสูตรคำนวณการปรับสมดุลของอาชีพใหม่รับค่าคูลดาวน์เป็นอินพุต ดังนั้นการปรับสมดุลจึงไม่ใช่ทางอ้อม แต่เป็นสาขาที่ 4 โดยตรง จำนวนสาขาที่กระทบคือ 4 สาขา ถึงอย่างนั้นระดับที่เลือกเป็น T1 ก็ไม่เปลี่ยน
