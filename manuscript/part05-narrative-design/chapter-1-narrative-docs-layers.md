...
ลองสังเกตรายการ `atoms:` ใน frontmatter ให้ดี ชื่อ atom ทั้งสามนี้ไม่ใช่เพียงบันทึกย่อ แต่เป็นตัวระบุ (identifier) ที่ออนโทโลยีในส่วนที่ 7 และแผนผังความสัมพันธ์ในส่วนที่ 11 ติดตามอยู่ เมื่อเควสต์ใดอ้างอิง `faction_quest_eligibility` เมื่อกฎนี้เปลี่ยน เควสต์นั้นก็จะถูกยกขึ้นมาในรายการที่ได้รับผลกระทบโดยอัตโนมัติ L1 เป็นผลงานเนื้อเรื่องที่ใกล้กับโค้ดของเกมที่สุด จึงทำงานจับคู่กับ System Designer (ออกแบบระบบ)
